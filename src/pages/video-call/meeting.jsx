...
export default () => {
  ...
  useEffect(() => {
    ...
    $(function () {
      ...
      var meeting_id = router.query.id;
    ...
    <main className="d-flex flex-column home-wrap">
      <div className="g-top text-light">
        <div className="top-remote-video-show-wrap d-flex">
          <div id="meetingContainer" className="w-75" style={{display: "none"}}>
      ...
      >
        ...
        <div
          className="bottom-middle d-flex just-content-center align-items-center"
          style={{height: "10vh"}}
        >
          <div
            className="
            ...
            id="micMuteUnmute"
          >
            <span className="material-icons" style={{width: "100%"}}>mic_off</span>
          </div>
          <div
            className="
              end-call-wrap
